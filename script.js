    ...
    function updateSitecheckerMessage() {
        setTimeout(() => {
            ...
            if (officialUrls.includes(pageUrl)) {
                ...
                messageElement.innerHTML = `This link <b>(${pageUrl})</b> is not an official Fenixo Browser link. Use at your own risk, or find a list of official Helios Browser links <a href="https://github.com/dinguschan-owo/Helios/blob/main/README.md" target="_blank" class="sitechecker-link">here</a>.`;
            }
...
(function () {
    ...
    function displayHeliosStarted() {
        ...
        addLogEntry(`[Fenixo Log] Helios started successfully`, true);
    }
...
const heliosSystemMessage = {
  role: "system",
  content: `You are Fenixo AI, an advanced AI assistant designed to be helpful, knowledgeable, and adaptable. You were made by Kingtootoo.`
};
  ...
  for (let model of models) {
    try {
      const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
        ...
        body: JSON.stringify({
          model: model.name,
          messages: [FenixoSystemMessage, ...heliosMessageHistory],
          temperature: 0.7,
          max_tokens: 2048,
...
document.addEventListener('DOMContentLoaded', function() {
    const contentFetchingProtocolExpectedOutput = "𝙼𝚊𝚍𝚎 𝚋𝚢 Kingtootoo!";
...
𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗲𝗱 𝗔𝗰𝘁𝗶𝗼𝗻𝘀:
• Visit [https://github.com/Kingtootoo/Fenixo] and verify your browser is up to date.
  ...
  <div class="dropdown-contentaa" id="engineDropdown-${currentTabIndex}">
    ...
    <a href="javascript:void(0);" onclick="selectEngine('https://duckduckgo.com/favicon.ico', 'DuckDuckGo', ${currentTabIndex})" data-engine="DuckDuckGo">
      <img src="https://duckduckgo.com/favicon.ico" alt="DuckDuckGo"> -<s>Search with DuckDuckGo</s>-
            ...
            <input type="text" placeholder="Search the web" id="search-input-${currentTabIndex}">
...
function openGitHub() {
    window.open('https://github.com/Kingtootoo/Fenixo/', '_blank');
}
...
function updateTabContent(url, content, tab) {
    ...
    if (url === 'Fenixo://new-tab') {
        content.innerHTML = `<div class="Xt7Lm9Kp3R8f">
  <p>𝙼𝚊𝚍𝚎 𝚋𝚢 Kingtootoo!</p>
</div><div class="top-right-boxaa">
  <p><i class="fa-brands fa-github"></i></p>
</div>
        <h23>Helios</h23>
...
<div class="theme-preview-lightmode" onclick="activatePreview(this)">
  ...
  <p class="theme-name-lightmode"><i>Dark Ember</i> by bromse</p>
    ...
    updateLockIcon(url);
    updateSpecialDivs(url);
    if (url === 'helios://start' || url === 'Fenixo://settings' || url === 'helios://urls') {
...
document.querySelector('.home-buttonaa').addEventListener('click', function() {
    changeTabContent('Fenixo://new-tab');
});
